...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'guide');
        ...
        return view('Guide::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'guide')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Guide'),
        ...
        return view('Guide::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Guide::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/guide/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Guide::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('guide');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('guide',$q);
    ...
    {
        $q = $request->query('q');
        $query = $this->attributesClass::selectRaw("id,name as text")->where('service','guide');
        if ($q) {
