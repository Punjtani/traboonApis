...
<div class="booking-review">
    ...
    <div class="booking-review-content">
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                @php $guides = \Modules\Guide\Models\GuideBooking::getByBookingId($booking->id) @endphp
                @if(!empty($guides))
                    @foreach($guides as $guide)
                        <li>
                            <div class="label">{{$service_translation->title}} * {{$booking->duration_nights}}</div>
                            <div class="val">
                                {{format_money($guide->price)}}
                                @php $total+=$guide->price @endphp
                            </div>
                        </li>
                    @endforeach
                @endif
