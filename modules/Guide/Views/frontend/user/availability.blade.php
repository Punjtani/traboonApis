...
@section ('content')
    <h2 class="title-bar no-border-bottom">
        ...
        <div class="title-action">
            <a class="btn btn-info" href="{{route('guide.vendor.room.index',['guide_id'=>$guide->id])}}">
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                        url:"{{route('guide.vendor.room.availability.loadDates',['guide_id'=>$guide->id])}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('guide.vendor.room.availability.store',['guide_id'=>$guide->id])}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
