...
<form action="{{ route("guide.search") }}" class="form bravo_form" method="get">
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="form-content">
                        ...
                        <div class="smart-search">
                            <input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("guide_location_search_style")) or setting_item("guide_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Where are you going?")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
            ...
            <div class="col-md-4 border-right">
                <div class="form-group">
                    ...
                    <div class="form-content">
                        <div class="form-date-search-guide">
                ...
                <div class="form-group">
                    ...
                    <div class="form-content dropdown-toggle" data-toggle="dropdown">
                        <div class="wrapper-more">
                            <label>{{__('Age')}}</label>
                            @php
                                $min_age = request()->query('min_age',18);
                                $max_age = request()->query('max_age',50);
                            @endphp
                            <div class="render">
