<div class="bravo_filter">
    ...
    <form action="{{ route("guide.search") }}" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                ...
                <div class="bravo-filter-price">
                    ...
                    $price_min = $pri_from = floor ( App\Currency::convertPrice($guide_min_max_price[0]) );

                    $price_max = $pri_to = ceil ( App\Currency::convertPrice($guide_min_max_price[1]) );
