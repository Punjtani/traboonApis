<div id="guide-rooms" class="guide_rooms_form" v-cloak="">
    <h3 class="heading-section">{{__('Guide Availability')}}</h3>
    ...
    <div class="guide_list_rooms" :class="{'loading':onLoadAvailability}">
        
    </div>
    <div class="guide_room_book_status" v-if="total_price">
        <div class="row">
            <div class="col-md-6">
