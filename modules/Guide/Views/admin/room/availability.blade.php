...
@section ('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Guide Availability Calendar")}}</h1>
        </div>
        ...
        @else
            <div class="alert alert-warning">{{__("No guides found")}}</div>
        @endif
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"{{route('guide.admin.room.availability.loadDates',['guide_id'=>$guide->id])}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    console.log('{{route('guide.admin.room.availability.store',['guide_id'=>$guide->id])}}');
                    var me = this;
                    ...
                    $.ajax({
                        url:'{{route('guide.admin.room.availability.store',['guide_id'=>$guide->id])}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
