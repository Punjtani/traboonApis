<div class="panel">
    <div class="panel-title"><strong>{{__("Guide Content")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{__("Title")}}</label>
            <input type="text" value="{{$translation->title}}" placeholder="{{__("Name of the guide")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
        ...
        @if(is_default_lang())
            <div class="form-group">
                <label class="control-label">{{__("Banner Image")}} (1900x600)</label>
...
<div class="panel">
    <div class="panel-title"><strong>{{__("Guide Policy")}}</strong></div>
    <div class="panel-body">
        @if(is_default_lang())
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Guide rating standard")}}</label>
