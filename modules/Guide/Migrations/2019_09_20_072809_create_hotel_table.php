...
class CreateHotelTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_guides', function (Blueprint $table) {
        ...
        Schema::create('bravo_guide_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_guide_term', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bravo_guides');
        Schema::dropIfExists('bravo_guide_translations');
        Schema::dropIfExists('bravo_guide_term');
