...
class ListActivity extends BaseBlock
{
    ...
    {
        $model_activity = Activity::select("bravo_activitys.*")->with(['location','translations','hasWishList']);
