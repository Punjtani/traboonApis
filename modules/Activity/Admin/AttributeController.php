...
class AttributeController extends AdminController
{
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('activity');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('activity',$q);
    ...
    {
        $q = $request->query('q');
        $query = $this->attributesClass::selectRaw("id,name as text")->where('service','activity');
        if ($q) {
