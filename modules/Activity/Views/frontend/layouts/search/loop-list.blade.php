...
@endphp
<div class="item-loop-list {{$wrap_class ?? ''}}" id="item-loop-list-{{$loop->index}}">
    <input type="hidden" value="{{$row->id}}" class="activity_id">
    ...
    <div class="g-info">
        ...
        <div class="terms">
                <div class="g-attributes">
                    <span class="attr-title"><i class="icofont-clock-time"></i> Duration: </span>
                   
                        <span class="item">{{$row->duration ?? ''}} hrs</span>
    ...
    <div class="g-rate-price">
        ...
        <a href="#"  @click='addActivityToSelected($event,"item-loop-list-{{$loop->index}}")'> <button class="btn btn-primary" title="Add to List"><span class="fa fa-plus-circle"></span></button></a>
        <div class="g-price">
        ...
        @endif
            ...
            <div class="price">
                <span class="text-price">{{ $row->display_price }} <span  class="unit">{{__("/activity")}}</span></span>
            </div>
