...
@section ('content')
    <h2 class="title-bar no-border-bottom">
        ...
        <div class="title-action">
            <a class="btn btn-info" href="{{route('activity.vendor.room.index',['activity_id'=>$activity->id])}}">
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                        url:"{{route('activity.vendor.room.availability.loadDates',['activity_id'=>$activity->id])}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('activity.vendor.room.availability.store',['activity_id'=>$activity->id])}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
