    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Duration in hours")}}</label>
                        <input type="text" value="{{$row->duration}}" placeholder="{{__("Eg: 2")}}" name="duration" class="form-control">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Activity Price")}}">
                        </div>
                    </div>
                    <div class="col-lg-6 d-none">
                        <div class="form-group">
                            <label class="control-label">{{__("Sale Price")}}</label>
                            <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Activity Sale Price")}}">
