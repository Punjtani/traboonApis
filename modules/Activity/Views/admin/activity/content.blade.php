<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="{{$translation->title}}" placeholder="{{__("Name of the activity")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<div class="panel">
    <div class="panel-title"><strong>{{__("Activity Policy")}}</strong></div>
    <div class="panel-body">
        @if(is_default_lang())
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{__("Activity rating standard")}}</label>
