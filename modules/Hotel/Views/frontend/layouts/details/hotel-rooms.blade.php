                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="hotel-info">
                                ...
                                <ul class="room-meta">
                                    <li  v-if="room.panorama">
                                        <div class="item"  data-toggle="modal" :data-target="'#myModal'+room.id" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{__('Room 360 Image')}}">
