...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Virtual Guide")}}</h1>
        </div>
        @include('admin.message')
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    <div class="panel-title">{{__("Add Virtual Guide")}}</div>
                    <div class="panel-body panel-index">
                        <form action="{{route('virtual.admin.store',['id'=>'-1','lang'=>request()->query('lang')])}}" method="post">
                            @csrf
                            @include('Virtual::admin/form')
                            <div class="form-group form-index-hide">
                                <label class="control-label">{{__("Virtual Map")}}</label>
                                ...
                                <p><i>{{__('Click onto map to place Virtual address')}}</i></p>
                            </div>
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/virtual/editBulk')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/virtual')}}" class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <table class="table table-hover">
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{url('admin/module/virtual/edit/'.$row->id)}}">{{$prefix.' '.$row->name}}</a>
                                        </td>
