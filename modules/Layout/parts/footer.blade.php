        ...
        <div class="container">
            <div class="row footer-mobile">
                            ...
                            <div class="nav-footer ">
                               ...
                               <center> <ul class=" float1">
    <li class="item float-item"><a href="#">Term &amp; Condition</a></li>
     <li class="item float-item"><a href="#">Why Traboon</a></li>
      <li class="item float-item"><a href="#">How it work</a></li>
       <li class="item float-item"><a href="#">Account</a></li>
        <li class="item float-item"><a href="#">Contact</a></li>
         <li class="item float-item"><a href="#">Affiliate Program</a></li>
          <li class="item float-item"><a href="#">Places</a></li>
          <li class="item float-item"><a href="#">Activites</a></li>
          <li class="item float-item"><a href="#">Cars</a></li>
  </ul>
  </center>
  </div>
            ...
            <div class="row footer-hide">
                @if($list_widget_footers = setting_item_with_lang("list_widget_footer"))
                    ...
                    @foreach($list_widget_footers as $key=>$item)
                        <div class="col-lg-{{$item->size ?? '3'}} col-md-6 footer-hide-{{$item->title}}">
                            <div class="nav-footer">
                                <div class="title">
                                    {{$item->title}}
                                </div>
