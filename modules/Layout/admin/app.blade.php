            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('TraBoOn.com by')}} <a href="{{__('http://faisitech.com/')}}" target="_blank">{{__('Faisitech Engineering Complex Pvt Ltd')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://faisitech.com/')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://faisitech.com/')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
