...
Route::group(['prefix'=>config('booking.booking_route_prefix')],function(){
    ...
    Route::post('/addToCartMany','BookingController@addToCartMany')->middleware('auth');
    ...
    Route::get('/{code}/bulk-checkout','BookingController@checkoutMany')->middleware('auth');
    Route::get('/{code}/check-status','BookingController@checkStatusCheckout')->middleware('auth');
    Route::get('/easypay-postback/{gateway}','BookingController@postBack')->middleware('auth');
