(function ($) {
    var activityForm = new Vue({
        ...
        mounted(){
            var me = this;
            /*$(".activity_room_book_status").sticky({
                topSpacing:30,
    ...
    $(".start_room_sticky").each(function () {
        var $this_list_room = $(this).closest(".activity_rooms_form");
        $(window).scroll(function() {
            ...
            if (stickyTop < windowTop && windowTop < stickyBottom) {
                $(document).find(".activity_room_book_status").addClass("sticky").css("width",$this_list_room.width());
                $(document).find(".end_room_sticky").css("min-height",$(document).find(".activity_room_book_status").height() + 32 + 20);

                setTimeout(function () {
                    $(document).find(".activity_room_book_status").addClass("active");
                },100);
            } else {
                $(document).find(".activity_room_book_status").removeClass("sticky").css("width","auto");
                $(document).find(".end_room_sticky").css("min-height","auto");
                $(document).find(".activity_room_book_status").removeClass("active");
            }
        });
    });
