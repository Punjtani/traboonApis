...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\EasyPay\Controllers';
    protected $adminModuleNamespace = 'Plugins\EasyPay\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/EasyPay')->group(__DIR__ . '/Routes/admin.php');
    }
